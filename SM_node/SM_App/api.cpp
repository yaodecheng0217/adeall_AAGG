...
int APP::set_ControlValue(uint16_t type, double value)
{
    ...
    switch (type)
    {
    case DATA_TYPE_LIST::Type_AcceleratorValue:return SetAcceleratorValue(value);
    case DATA_TYPE_LIST::Type_AUTO:return SetAuto(value);
    case DATA_TYPE_LIST::Type_BrakeValue:return SetBrake(value);
    case DATA_TYPE_LIST::Type_LED_Green:return SetLedGreen(value);
    case DATA_TYPE_LIST::Type_LED_Red:return SetLedRed(value);
    case DATA_TYPE_LIST::Type_LiftValue:return SetLift(value);
    case DATA_TYPE_LIST::Type_MoveForwardValue:return SetMoveForward(value);
    case DATA_TYPE_LIST::Type_Paking:return SetPacking(value);
    case DATA_TYPE_LIST::Type_SideValue:return SetSide(value);
    case DATA_TYPE_LIST::Type_TiltValue:return SetTilt(value);
    case DATA_TYPE_LIST::Type_TurnAngleValue:return SetTurnAngle(value);
        break;
    default:
        break;
    }
