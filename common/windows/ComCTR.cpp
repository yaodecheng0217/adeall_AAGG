...
bool ComCTR::WriteData(const char* pData, unsigned int length)
{
    BOOL   bResult = TRUE;
...
DWORD WINAPI  ComCTR::Comrecv(void* args)
{
...
DWORD WINAPI  ComCTR::Comrecv2(void* args)
{
	ComCTR* P = (ComCTR*)args;
	char b;
	while (true)
